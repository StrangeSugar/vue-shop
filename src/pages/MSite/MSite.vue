<template>
  <section class="msite">
        ...
        <Header >
           <span class="header_search" slot="left">
             ...
             <span class="header_title" slot="center">
              <span class="header_title_text ellipsis">{{address||'定位中'}}</span>
            </span>
        ...
        <!--首页导航-->
        <nav class="msite_nav" v-if="categorysArr.length>0">
          <div class="swiper-container">
            <div class="swiper-wrapper">
              <div class="swiper-slide" v-for='(silde,index) in categorysArr' :key="index">
                <a  class="link_to_food" v-for="(food) in silde" :key="food.id" :href="food.link">
                  ...
                  <div class="shop_right">
                    <section class="shop_detail_header">
                      ...
                      <ul class="shop_detail_ul">
                        <li class="supports" v-for=" (supports) in shop.supports" :key="supports.id">{{supports.icon_name}}</li>
...
.swiper-container
  ...
  --swiper-pagination-color: #134485;/* 两种都可以 */
.msite  //首页
